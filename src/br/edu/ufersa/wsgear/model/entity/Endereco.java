...
public class Endereco {
	...
	public Endereco(String cep, String rua, String bairro, String complemento, int numero) {
		setCep(cep);
		setRua(rua);
		setBairro(bairro);
	...
	public static Endereco converter(EnderecoDTO dto) {
		Endereco endereco = new Endereco();
		endereco.setBairro(dto.getBairro());
		endereco.setCep(dto.getCep());
		endereco.setComplemento(dto.getComplemento());
		endereco.setCpf_morador(dto.getCpf_morador());
